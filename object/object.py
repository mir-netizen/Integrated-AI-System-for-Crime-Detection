...
# Load general object detection model (80+ COCO objects)
model = YOLO('yolov8n.pt')
print("Object Detection Service (General) is running...")
...
for message in consumer:
    ...
    if detections:
        ...
        print(f"Detected {len(detections)} objects for clip {data.get('clip_id', 'N/A')[:12]} frame {data.get('frame_index', 'N/A')}")
